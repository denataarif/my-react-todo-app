...
import carCardSlice from '../../Store/carCardSlice'
...
const Car = (props) => {
    ...
    const carCard = useSelector((store)=>store.carCardSlice.carCard)
            ...
            { car !== null &&
                ...
                <PanelDisabled/>
                        ...
                        <div className='details-container'>
                            ...
                            <div className='details-container-right'>
                                <div className='details-container-right-inner'>
                                    ...
                                    <button onClick={ () => dispatch(carCardSlice.actions.addCarToCard({ id: car.id })) }  className='btn button-right-details-container'>
                    ...
                    <div className='button-center-container-outer'>
                        <button onClick={ () => dispatch(carCardSlice.actions.addCarToCard({ id: car.id })) } className='btn button-center-container'>
